...
export class ButtonAddMine extends Button {
    ...
    constructor(guiVertPosition:number, upgradeSection:UpgradeSection, mineState:MineState, gui:GUIPlay) {
        ...
        this.onPointerDownObservable.add(() => {
            if (gui.scene.mathState.totalGold > this._costGold && gui.scene.mathState.totalFarmers > this._costFarmers) {
                ...
                //add the miners
                let count = gui.scene.mathState.mineState.upgradeCostFarmers;
                ...
                gui.scene.mathState.totalGold =  gui.scene.mathState.totalGold - this._costGold;
