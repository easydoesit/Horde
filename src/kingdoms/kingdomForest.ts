...
import { DEBUGMODE, kingForest } from "../utils/CONSTANTS";
import { Kingdom } from "./kingdom";
import { PlayMode } from "../scenes/playmode";

export class KingdomForest extends Kingdom {
    private _mainLight:DirectionalLight;

    constructor(scene:PlayMode) {
        super(kingForest.name, scene);
        this._name = kingForest.name;

        this._level = kingForest.level;
        
        this._baseGoldBoost = kingForest.baseGoldBoost;
        this._baseResourceBoost = kingForest.baseResourceBoost;
     
        this._costToUnlockGold = kingForest.costToUnlockGold;
        this._costToUnlockFarmers = kingForest.costToUnlockFarmers;
        this._costToUnlockResources = kingForest.costToUnlockResources;
        this._importedModels = kingForest.importedModels;

        this._prestigeLumens = kingForest.prestigeLumens;
