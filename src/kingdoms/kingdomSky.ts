...
import { DEBUGMODE, kingSky } from "../utils/CONSTANTS";
import { Kingdom } from "./kingdom";
import { PlayMode } from "../scenes/playmode";

export class KingdomSky extends Kingdom {
    private _mainLight:DirectionalLight;

    constructor(scene:PlayMode) {
        super(kingSky.name, scene);
        this._name = kingSky.name;

        this._level = kingSky.level;
        
        this._baseGoldBoost = kingSky.baseGoldBoost;
        this._baseResourceBoost = kingSky.baseResourceBoost;
     
        this._costToUnlockGold = kingSky.costToUnlockGold;
        this._costToUnlockFarmers = kingSky.costToUnlockFarmers;
        this._costToUnlockResources = kingSky.costToUnlockResources;
        this._importedModels = kingSky.importedModels;

        this._prestigeLumens = kingSky.prestigeLumens;
