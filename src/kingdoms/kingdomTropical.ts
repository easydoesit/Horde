...
import { DEBUGMODE, kingTropical } from "../utils/CONSTANTS";
import { Kingdom } from "./kingdom";
import { PlayMode } from "../scenes/playmode";

export class KingdomTropical extends Kingdom {
    private _mainLight:DirectionalLight;

    constructor(scene:PlayMode) {
        super(kingTropical.name, scene);
        this._name = kingTropical.name;

        this._level = kingTropical.level;
        
        this._baseGoldBoost = kingTropical.baseGoldBoost;
        this._baseResourceBoost = kingTropical.baseResourceBoost;
     
        this._costToUnlockGold = kingTropical.costToUnlockGold;
        this._costToUnlockFarmers = kingTropical.costToUnlockFarmers;
        this._costToUnlockResources = kingTropical.costToUnlockResources;
        this._importedModels = kingTropical.importedModels;

        this._prestigeLumens = kingTropical.prestigeLumens;
