...
import { DEBUGMODE, kingMoon } from "../utils/CONSTANTS";
import { Kingdom } from "./kingdom";
import { PlayMode } from "../scenes/playmode";

export class KingdomMoon extends Kingdom {
    private _mainLight:DirectionalLight;

    constructor(scene:PlayMode) {
        super(kingMoon.name, scene);
        this._name = kingMoon.name;

        this._level = kingMoon.level;
        
        this._baseGoldBoost = kingMoon.baseGoldBoost;
        this._baseResourceBoost = kingMoon.baseResourceBoost;
     
        this._costToUnlockGold = kingMoon.costToUnlockGold;
        this._costToUnlockFarmers = kingMoon.costToUnlockFarmers;
        this._costToUnlockResources = kingMoon.costToUnlockResources;
        this._importedModels = kingMoon.importedModels;

        this._prestigeLumens = kingMoon.prestigeLumens;
