...
import { DEBUGMODE, kingCoast } from "../utils/CONSTANTS";
import { Kingdom } from "./kingdom";
import { PlayMode } from "../scenes/playmode";

export class KingdomCoast extends Kingdom {
    private _mainLight:DirectionalLight;

    constructor(scene:PlayMode) {
        super(kingCoast.name, scene);
        this._name = kingCoast.name;

        this._level = kingCoast.level;
        
        this._baseGoldBoost = kingCoast.baseGoldBoost;
        this._baseResourceBoost = kingCoast.baseResourceBoost;
     
        this._costToUnlockGold = kingCoast.costToUnlockGold;
        this._costToUnlockFarmers = kingCoast.costToUnlockFarmers;
        this._costToUnlockResources = kingCoast.costToUnlockResources;
        this._importedModels = kingCoast.importedModels;

        this._prestigeLumens = kingCoast.prestigeLumens;
