...
import { DEBUGMODE, kingWaterfall } from "../utils/CONSTANTS";
import { Kingdom } from "./kingdom";
import { PlayMode } from "../scenes/playmode";

export class KingdomWaterfall extends Kingdom {
    private _mainLight:DirectionalLight;

    constructor(scene:PlayMode) {
        super(kingWaterfall.name, scene);
        this._name = kingWaterfall.name;

        this._level = kingWaterfall.level;
        
        this._baseGoldBoost = kingWaterfall.baseGoldBoost;
        this._baseResourceBoost = kingWaterfall.baseResourceBoost;
     
        this._costToUnlockGold = kingWaterfall.costToUnlockGold;
        this._costToUnlockFarmers = kingWaterfall.costToUnlockFarmers;
        this._costToUnlockResources = kingWaterfall.costToUnlockResources;
        this._importedModels = kingWaterfall.importedModels;

        this._prestigeLumens = kingWaterfall.prestigeLumens;
