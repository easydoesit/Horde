...
import { DEBUGMODE, kingOasis } from "../utils/CONSTANTS";
import { Kingdom } from "./kingdom";
import { PlayMode } from "../scenes/playmode";

export class KingdomOasis extends Kingdom {
    private _mainLight:DirectionalLight;

    constructor(scene:PlayMode) {
        super(kingOasis.name, scene);
        this._name = kingOasis.name;

        this._level = kingOasis.level;
        
        this._baseGoldBoost = kingOasis.baseGoldBoost;
        this._baseResourceBoost = kingOasis.baseResourceBoost;
     
        this._costToUnlockGold = kingOasis.costToUnlockGold;
        this._costToUnlockFarmers = kingOasis.costToUnlockFarmers;
        this._costToUnlockResources = kingOasis.costToUnlockResources;
        this._importedModels = kingOasis.importedModels;

        this._prestigeLumens = kingOasis.prestigeLumens;
