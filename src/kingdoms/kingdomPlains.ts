...
import { DEBUGMODE, kingPlains } from "../utils/CONSTANTS";
import { Kingdom } from "./kingdom";
import { PlayMode } from "../scenes/playmode";

export class KingdomPlains extends Kingdom {
    ...
    constructor(scene:PlayMode) {
        ...
        this._baseGoldBoost = kingPlains.baseGoldBoost;
        this._baseResourceBoost = kingPlains.baseResourceBoost;
     
        this._costToUnlockGold = kingPlains.costToUnlockGold;
        this._costToUnlockFarmers = kingPlains.costToUnlockFarmers;
        this._costToUnlockResources = kingPlains.costToUnlockResources;
        this._importedModels = kingPlains.importedModels;

        this._prestigeLumens = kingPlains.prestigeLumens;
        
        //make sure this initial position is below the map.
        this._models = [];
        this._hiddenPos = new Vector3(0, -2000, 0);
