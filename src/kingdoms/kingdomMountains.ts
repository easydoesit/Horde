...
import { DEBUGMODE, kingMountains } from "../utils/CONSTANTS";
import { Kingdom } from "./kingdom";
import { PlayMode } from "../scenes/playmode";

export class KingdomMountains extends Kingdom {
    private _mainLight:DirectionalLight;

    constructor(scene:PlayMode) {
        super(kingMountains.name, scene);
        this._name = kingMountains.name;

        this._level = kingMountains.level;
        
        this._baseGoldBoost = kingMountains.baseGoldBoost;
        this._baseResourceBoost = kingMountains.baseResourceBoost;
     
        this._costToUnlockGold = kingMountains.costToUnlockGold;
        this._costToUnlockFarmers = kingMountains.costToUnlockFarmers;
        this._costToUnlockResources = kingMountains.costToUnlockResources;
        this._importedModels = kingMountains.importedModels;

        this._prestigeLumens = kingMountains.prestigeLumens;
