...
import { DEBUGMODE, kingInterDimensional } from "../utils/CONSTANTS";
...
export class KingdomInterDimensional extends Kingdom {
    ...
    constructor(scene:PlayMode) {
        super(kingInterDimensional.name, scene);
        this._name = kingInterDimensional.name;

        this._level = kingInterDimensional.level;
        
        this._baseGoldBoost = kingInterDimensional.baseGoldBoost;
        this._baseResourceBoost = kingInterDimensional.baseResourceBoost;
     
        this._costToUnlockGold = kingInterDimensional.costToUnlockGold;
        this._costToUnlockFarmers = kingInterDimensional.costToUnlockFarmers;
        this._costToUnlockResources = kingInterDimensional.costToUnlockResources;
        this._importedModels = kingInterDimensional.importedModels;

        this._prestigeLumens = kingInterDimensional.prestigeLumens;
