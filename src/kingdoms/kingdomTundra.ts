...
import { DEBUGMODE, kingTundra } from "../utils/CONSTANTS";
import { Kingdom } from "./kingdom";
import { PlayMode } from "../scenes/playmode";

export class KingdomTundra extends Kingdom {
    private _mainLight:DirectionalLight;

    constructor(scene:PlayMode) {
        super(kingTundra.name, scene);
        this._name = kingTundra.name;

        this._level = kingTundra.level;
        
        this._baseGoldBoost = kingTundra.baseGoldBoost;
        this._baseResourceBoost = kingTundra.baseResourceBoost;
     
        this._costToUnlockGold = kingTundra.costToUnlockGold;
        this._costToUnlockFarmers = kingTundra.costToUnlockFarmers;
        this._costToUnlockResources = kingTundra.costToUnlockResources;
        this._importedModels = kingTundra.importedModels;

        this._prestigeLumens = kingTundra.prestigeLumens;
