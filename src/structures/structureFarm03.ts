...
import { DEBUGMODE, farm03 } from "../utils/CONSTANTS";
...
export class StructureFarm03 extends StructureState implements StructureStateChildI {
    ...
    constructor(scene:PlayMode){
        ...
        this._animationPaths = farm03.paths;
    ...
    public upgradeState() {
        ...
        if (this.getUpgradeLevel() < this._upgradeMax) {
            ...
            this.getUpgradeSection().changeInstruction(`Next upgrade allows ${checkUpgradeFarmersMax(this)} farmers on your 3rd farm`);
